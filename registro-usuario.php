        ...
        <div class="row justify-content-center">
            <div class="col-8 p-5 bg-white shadow-lg rounded">
                ...
                if (isset($_POST['registro'])) {
                    ...
                    if ($query->rowCount() > 0) {
                        echo '<div class="alert alert-danger" role="alert">El correo electronico ya a sido registrado!</div>';
                    }
                    ...
                    if ($query->rowCount() == 0) {
                        ...
                        if ($result) {
                            ...
                            echo '<div class="alert alert-danger" role="alert">Tenemos un error!</div>';
                        }
                    }
                }
                ?>
